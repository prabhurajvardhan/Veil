 ...
 * - T003 (Current Task): Provides ScreenshotData via CDP Page.captureScreenshot and CDP session management.
 * - T004 (Next Task): Captures and populates dom_tree (CDP.DOM.Node) and a11y_tree (CDP.Accessibility.AXNode[]).
 * - Completed M02: Combines ScreenshotData (T003) + DOM/A11y (T004) to construct RawObservation for M03-M05.
 */
export interface RawObservation {
  ...
  dom_tree: CDP.DOM.Node; // Raw CDP DOM Tree (Populated by T004)
  a11y_tree: CDP.Accessibility.AXNode[]; // Raw CDP A11y Tree (Populated by T004)
}
